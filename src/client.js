...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			"eol.hint": "模型跑的 git 命令按 Linux 行为:core.autocrlf=false、core.eol=lf。你自己终端的 git 与仓库里的 .gitattributes 都不受影响。",
		...
		var en = {
			...
			"eol.hint": "Git commands the model runs behave like Linux: core.autocrlf=false, core.eol=lf. Your own terminal's git and a repository's .gitattributes are unaffected.",
		...
		var LOCALES = {
			...
			"ar": {
				...
				"eol.hint": "أوامر git التي يشغّلها النموذج تتبع سلوك لينكس: core.autocrlf=false و core.eol=lf؛ لا يتأثر طرفيتك ولا ملف .gitattributes للمستودع.",
			...
			"de": {
				...
				"eol.hint": "Vom Modell ausgeführte git-Befehle verhalten sich wie unter Linux: core.autocrlf=false, core.eol=lf. Dein eigenes Terminal und die .gitattributes eines Repos bleiben unberührt.",
			...
			"fr": {
				...
				"eol.hint": "Les commandes git lancées par le modèle suivent le comportement Linux : core.autocrlf=false, core.eol=lf. Votre terminal et les .gitattributes du dépôt ne sont pas touchés.",
			...
			"hi": {
				...
				"eol.hint": "मॉडल द्वारा चलाए git कमांड Linux व्यवहार अपनाते हैं: core.autocrlf=false, core.eol=lf। आपका टर्मिनल और रेपो का .gitattributes अछूते रहते हैं।",
			...
			"id": {
				...
				"eol.hint": "Perintah git yang dijalankan model mengikuti perilaku Linux: core.autocrlf=false, core.eol=lf. Terminal Anda dan .gitattributes repo tidak terpengaruh.",
			...
			"it": {
				...
				"eol.hint": "I comandi git eseguiti dal modello seguono il comportamento Linux: core.autocrlf=false, core.eol=lf. Il tuo terminale e i .gitattributes del repo non vengono toccati.",
			...
			"ja": {
				...
				"eol.hint": "モデルが実行する git コマンドは Linux と同じ挙動になります: core.autocrlf=false、core.eol=lf。あなたのターミナルやリポジトリの .gitattributes は影響を受けません。",
			...
			"ko": {
				...
				"eol.hint": "모델이 실행하는 git 명령은 Linux 동작을 따릅니다: core.autocrlf=false, core.eol=lf. 사용자의 터미널과 저장소의 .gitattributes는 영향을 받지 않습니다.",
			...
			"nl": {
				...
				"eol.hint": "Git-opdrachten die het model uitvoert volgen Linux-gedrag: core.autocrlf=false, core.eol=lf. Je eigen terminal en de .gitattributes van een repo blijven onaangetast.",
			...
			"pl": {
				...
				"eol.hint": "Polecenia git uruchamiane przez model działają jak w Linuksie: core.autocrlf=false, core.eol=lf. Twój terminal i .gitattributes repozytorium pozostają nietknięte.",
			...
			"pt": {
				...
				"eol.hint": "Os comandos git executados pelo modelo seguem o comportamento do Linux: core.autocrlf=false, core.eol=lf. O seu terminal e os .gitattributes do repositório não são afetados.",
			...
			"ru": {
				...
				"eol.hint": "Команды git, запускаемые моделью, ведут себя как в Linux: core.autocrlf=false, core.eol=lf. Ваш терминал и .gitattributes репозитория не затрагиваются.",
			...
			"sv": {
				...
				"eol.hint": "Git-kommandon som modellen kör följer Linux-beteende: core.autocrlf=false, core.eol=lf. Din egen terminal och repots .gitattributes påverkas inte.",
			...
			"th": {
				...
				"eol.hint": "คำสั่ง git ที่โมเดลรันจะใช้พฤติกรรมแบบ Linux: core.autocrlf=false, core.eol=lf เทอร์มินัลของคุณและ .gitattributes ของ repo ไม่ได้รับผลกระทบ",
			...
			"tr": {
				...
				"eol.hint": "Modelin çalıştırdığı git komutları Linux davranışını izler: core.autocrlf=false, core.eol=lf. Kendi terminaliniz ve deponun .gitattributes dosyası etkilenmez.",
			...
			"vi": {
				...
				"eol.hint": "Các lệnh git do mô hình chạy theo hành vi Linux: core.autocrlf=false, core.eol=lf. Terminal của bạn và .gitattributes của repo không bị ảnh hưởng.",
			...
			"zh-hk": {
				...
				"eol.hint": "模型執行的 git 指令採 Linux 行為:core.autocrlf=false、core.eol=lf。你自己終端的 git 與倉庫的 .gitattributes 都不受影響。",
